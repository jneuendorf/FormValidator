...
<ul class="spaced">
    ...
    <li>
        ...
        Range can be defined with <code>data-fv-min</code> &amp; <code>data-fv-max</code>.
    </li>
    <li>
        <code>number</code><br>
        any number <var class="math">x</var> &#8712; &#8477; (more exactly <span class="math">&#8474;</span>),<br>
    ...
    <li>
        <code>phone</code><br>
        any combination of <code>"0123456789+-/() "</code> that's longer than 2 characters,<br>
    ...
    <li>
        <code>select</code><br>
        the selected item's value is not <code>null</code> and at least 1 character long,
        As with <code>text</code> a minimum and maximum length can be defined using <code>data-fv-min</code> and <code>data-fv-max</code>.
    </li>
    <li>
        <code>text</code><br>
