...
(function() {
  var BUILD_MODES, CONSTRAINT_VALIDATOR_OPTIONS, DEBUG, DEFAULT_ATTR_VALUES, ERROR_MESSAGE_CONFIG, ERROR_MODES, ERROR_OUTPUT_MODES, EXPOSED_CONSTANTS, FormModifier, OPTIONAL_CACHE, REQUIRED_CACHE, VALIDATION_PHASES, VALIDATION_PHASES_SINGULAR, build_mode_helpers, constraint_validator_groups, constraint_validator_options_in_locale_key, constraint_validators, default_message_builder, enumerate_message_builder, error_message_builders, get_combined_key, get_permutations, get_subsets, group_arr_by, include_constraint_option_in_locale_key, list_message_builder, locale_build_mode_helpers, locales, message_builders, parse_deps, part_evaluator, permutation_cache, sentence_message_builder, set, set_add, set_remove, toposort, validators,
  ...
  build_mode_helpers[BUILD_MODES.ENUMERATE] = function(parts, locale, phase, build_mode, error_data) {
  ...
  build_mode_helpers[BUILD_MODES.SENTENCE] = function(parts, locale, phase, build_mode, error_data) {
    var first_to_upper, i, l, len, part, prefix, suffix;
    phase = VALIDATION_PHASES_SINGULAR[phase].toLowerCase();
    prefix = locales[locale][(phase + "_" + build_mode + "_prefix").toLowerCase()] || "";
    suffix = locales[locale][(phase + "_" + build_mode + "_suffix").toLowerCase()] || "";
    first_to_upper = prefix && !(prefix instanceof Function) && prefix[0] !== "{";
  ...
  build_mode_helpers[BUILD_MODES.LIST] = function(parts, locale, phase, build_mode, error_data) {
    var part;
  ...
  default_message_builder = function(key, phase, build_mode, locale, parts, error_data, prefix, suffix, prefix_delimiter, suffix_delimiter) {
    var base, message, result;
    ...
    if (parts instanceof Array) {
      message = (typeof (base = locale_build_mode_helpers[locale])[build_mode] === "function" ? base[build_mode](parts, locale, phase, build_mode) : void 0) || build_mode_helpers[build_mode](parts, locale, phase, build_mode, error_data);
    } else {
      message = parts;
    }
    result = [];
  ...
  enumerate_message_builder = function(key, phase, build_mode, locale, parts, error_data, prefix, suffix, prefix_delimiter, suffix_delimiter) {
    if (prefix_delimiter == null) {
      prefix_delimiter = " ";
    }
    if (suffix_delimiter == null) {
  ...
  sentence_message_builder = function(key, phase, build_mode, locale, parts, error_data, prefix, suffix, prefix_delimiter, suffix_delimiter) {
    if (prefix_delimiter == null) {
      prefix_delimiter = " ";
    }
    if (suffix_delimiter == null) {
  ...
  list_message_builder = function(key, phase, build_mode, locale, parts, error_data, prefix, suffix, prefix_delimiter, suffix_delimiter) {
    if (prefix_delimiter == null) {
      prefix_delimiter = " ";
    }
    if (suffix_delimiter == null) {
  ...
  error_message_builders[VALIDATION_PHASES.CONSTRAINTS] = function(errors, phase, build_mode, locale) {
    ...
    return message_builders[build_mode.toLowerCase()](key, phase, build_mode, locale, parts, error_data, prefix);
  };
