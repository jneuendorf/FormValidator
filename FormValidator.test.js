...
(function() {
  var FORM_HTML, include_general_behavior_tests, include_validator_tests, log;
  ...
  include_general_behavior_tests = function() {
    return describe("general behavior", function() {
      ...
      describe("return value + side fx", function() {
      ...
      return describe("dependencies among fields", function() {});
    });
  };
