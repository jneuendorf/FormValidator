...
Sequence = (function() {
  ...
  Sequence.prototype._createParamListFromContext = function(func, context) {
    ...
    if (!(context instanceof Array)) {
      ...
      temp = [];
      for (l = 0, len = paramList.length; l < len; l++) {
        argName = paramList[l];
...
FormModifier = (function() {
  ...
  FormModifier.prototype._apply_classes = function(element, targets, classes, is_valid) {
    var i, l, len, target;
    if (targets != null) {
