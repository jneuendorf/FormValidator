...
(function() {
  ...
  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.DISPLAY] = function(element, valid) {
    var orig_display;
    if (!valid) {
  ...
  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.ENABLE] = function(element, valid) {
    return element.prop("disabled", !valid);
  };

  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.FADE] = function(element, valid) {
    if (valid) {
  ...
  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.OPACITY] = function(element, valid) {
    var orig_opacity;
    if (!valid) {
  ...
  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.SHOW] = function(element, valid) {
    if (valid) {
  ...
  dependency_change_actions[DEPENDENCY_CHANGE_ACTION.SLIDE] = function(element, valid) {
    if (valid) {
  ...
  window.FormValidator = (function() {
    ...
    *
    ...
    FormValidator.prototype._dependency_change = function(action, element, valid) {
      var CLASS, ref;
      CLASS = this.constructor;
      if ((ref = CLASS.dependency_change_actions[action]) != null) {
        ref.call(CLASS.dependency_change_actions, element, valid);
      }
      return this;
    };
    ...
    FormValidator.prototype._validate_element = function(elem, data, value_info, options) {
      ...
      if (!valid_dependencies) {
        ...
        if (data.valid_dependencies !== false) {
          this._dependency_change(data.dependency_change_action, elem, false);
        }
        ...
        data.errors[phase] = [];
        if (data.valid_dependencies !== true) {
          this._dependency_change(data.dependency_change_action, elem, true);
        }
      }
