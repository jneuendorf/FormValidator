...
(function() {
  var BUILD_MODES, CACHED_FIELD_DATA, DEBUG, ERROR_MESSAGE_CONFIG, ERROR_MODES, ERROR_OUTPUT_MODES, VALIDATION_PHASES, build_mode_helpers, constraint_validator_options, constraint_validators, error_message_builders, error_messages, locale_build_mode_helpers, locales, message_builder, validators,
  ...
  message_builder = function(key, build_mode, locale, parts, prefix, suffix) {
    var base, message;
  ...
  window.FormValidator = (function() {
    ...
    *
    ...
    FormValidator.prototype._group_errors = function(errors, options) {
      var CLASS, elem, error, fields, i, j, message, ref, result;
      CLASS = this.constructor;
      result = [];
      ...
      for (i = j = 0, ref = fields.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
        ...
        if (options.messages === true) {
          message = CLASS.get_error_message_for_element(elem, errors, this.build_mode, this.locale);
        } else {
          message = "";
        }
        result.push({
