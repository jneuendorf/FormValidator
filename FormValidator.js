...
(function() {
  var CACHED_FIELD_DATA, DEBUG, ERROR_MODES, ERROR_OUTPUT_MODES, constraint_validator_options, constraint_validators, error_messages, validators,
  ...
  window.FormValidator = (function() {
    ...
    FormValidator.get_error_message_for_element = function(element, errors) {
      var elem_errors, error;
      return elem_errors = (function() {
        var j, len, results1;
        results1 = [];
    ...
    *
    ...
    FormValidator.prototype._group_errors = function(errors, options) {
      ...
      for (i = j = 0, ref = fields.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
        ...
        message = options.messages === true ? CLASS.get_error_message_for_element(elem, errors) : "";
        result.push({
          element: elem,
          errors: errors,
          message: message
